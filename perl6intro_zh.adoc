...
注意： 可以前到 https://docs.perl6.org/language/operators 查看完整的运算符列表和它们的优先级。
...
注意： 所有可应用于字符串的方法列表，请参照https://docs.perl6.org/type/Str
...
注意： 所有可应用于整数的方法列表，请参照https://docs.perl6.org/type/Int
...
注意： 所有可应用于有理数的方法列表，请参照https://docs.perl6.org/type/Rat
...
注意：对于完整的数组参考资料，请参见https://docs.perl6.org/type/Array
...
注意： 完整的哈希参考资料，请见https://docs.perl6.org/type/Hash
...
注意： 关于变量的更多信息，请见： https://docs.perl6.org/language/variables
...
注意： 更多关于循环和条件语句的信息，参见 https://docs.perl6.org/language/control
...
注意： 更多关于 I/O，详见 https://docs.perl6.org/type/IO

== 子例程
=== 定义
*子例程* (也叫 *subs* 或 *functions*) 是一种功能集的打包。 +

定义子例程时以关键字 `sub` 起始。在定义之后你能通过子例程名(句柄？handle)来进行调用。+
让我们来看下面的例子：
...
注意： 关于更多子例程和函数的资料，详见 https://docs.perl6.org/language/functions
